...
class SEOCustomer(models.Model):
    ...
    rand_id = models.IntegerField(verbose_name='随机数', default=random.randint(1, MAX_VALUE))
    create_date = models.DateTimeField(verbose_name='创建时间', default=datetime.now, blank=True)
    update_date = models.DateTimeField(verbose_name='更新时间', blank=True, null=True, default=datetime.now)
