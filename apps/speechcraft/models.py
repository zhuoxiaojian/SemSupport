...
class Speechcraft(models.Model):
    ...
    speechAnswer = UEditorField(verbose_name='话术对应内容', null=True, blank=True, width=1200, height=300, toolbars="full", imagePath='ueditor/', filePath='ueditor/', upload_settings={"imageMaxSize": 1204000})
        # models.TextField(verbose_name='话术对应内容', null=True, blank=True)
