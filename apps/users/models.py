...
class UserProfile(AbstractUser):
    ...
    depart = models.ForeignKey(TSDepart, verbose_name='所有部门', on_delete=models.SET_NULL, null=True, default=None)
    city = models.ForeignKey(FormRegionCity, verbose_name='销售负责区域', on_delete=models.SET_NULL, null=True, default=None)
