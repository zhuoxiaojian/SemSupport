...
from works.views import OneKeyInitWork, OneKeyClearWork
...
urlpatterns = [
    ...
    url(r'^admin/works/customeruser/onekeyclearbackwork', OneKeyClearWork.as_view(), name='onekeyclearbackwork')
]
